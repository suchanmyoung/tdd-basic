...
public class ExpiryDateCalculatorTest {
    ...
    void 납부일과_한달뒤_일자가_같지_않음(){
        ...
        //테스트 실패 같지만, plusMonths() 메소드가 한 달 추가 처리 시 예외처리를 해 준다.
        assertExpiryDate(
                PayData.builder()
    ...
    @Test
    void 로컬데이트_에_숫자를_더하면_값은(){
        LocalDate of = LocalDate.of(2019, 4, 1);
        LocalDate plusMonths = of.plusMonths(1);

        assertEquals(plusMonths, LocalDate.of(2019, 5, 1));
    }
}
